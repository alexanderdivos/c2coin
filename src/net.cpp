...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "C2coin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"c2coin.web-lab.at", "c2c.web-lab.at"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"c2coin.web-lab.at", "testnet-c2c.web-lab.at"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. C2coin is probably already running."), addrBind.ToString().c_str());
        else
